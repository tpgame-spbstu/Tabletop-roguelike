...
static func get_temp_map_config():
	...
	var loc3 = MapPointConfig.new(fight_scene, {"shuffle_seed": 1337, "ai_card_queue": card_queue2}, Vector2(1, 2),
		["res://Map/Location/point_textures/texture_cheese_albedo.png", "res://Map/Location/point_textures/texture_cheese_albedo.png"])
	var loc2 = MapPointConfig.new(sacrifice_scene, {}, Vector2(1, 1))
	var loc1 = MapPointConfig.new("", {}, Vector2(0, 0))
	...
	temp_map_config.current_map_point_config = loc1
